...
.PHONY: setup app-run app-demo app-docker app-run-docker app-demo-docker layer1-train layer1-train-active layer1-run layer1-chat layer1-reset-state layer1-docker layer1-train-docker layer1-run-docker layer1-chat-docker layer1-reset-state-docker layer1-rl-generate layer1-rl-train layer1-rl-check layer1-rl-generate-docker layer1-rl-train-docker layer1-rl-check-docker layer2-run layer2-docker layer2-migrate layer2-check layer2-test layer2-reset-runtime layer2-run-docker layer2-migrate-docker layer2-check-docker layer2-test-docker layer2-reset-runtime-docker layer3-run layer3-docker layer3-run-docker
